...
export const logOrNot = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get("http://localhost:8000/api/v1/isLogin", config);
...
export const changePass = (userData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put("http://localhost:8000/api/v1/changePassword", userData, config)
...
export const deleteAccount = (userData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put("http://localhost:8000/api/v1/deleteAccount", userData, config)
