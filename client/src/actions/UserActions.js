...
export const registerUser = (userData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post("https://hirehub-i0p4.onrender.com/api/v1/register", userData);
...
export const loginUser = (userData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post("https://hirehub-i0p4.onrender.com/api/v1/login", userData);
...
export const logOrNot = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get("https://hirehub-i0p4.onrender.com/api/v1/isLogin", config);
...
export const me = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get("https://hirehub-i0p4.onrender.com/api/v1/me", config);
...
export const changePass = (userData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put("https://hirehub-i0p4.onrender.com/api/v1/changePassword", userData, config)
...
export const updateProfile = (userData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put("https://hirehub-i0p4.onrender.com/api/v1/updateProfile", userData, config)
...
export const deleteAccount = (userData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put("https://hirehub-i0p4.onrender.com/api/v1/deleteAccount", userData, config)
