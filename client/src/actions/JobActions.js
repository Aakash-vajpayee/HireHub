...
export const createJobPost = (jobData) => async (dispatch) => {
    try{
        ...
        const {data} = await axios.post("https://hirehub-i0p4.onrender.com/api/v1/create/job",jobData,config) ;        
...
export const getAllJobs = () => async (dispatch) => {
    try{
        ...
        const {data} = await axios.get("https://hirehub-i0p4.onrender.com/api/v1/jobs") ;
...
export const getSingleJob = (id) => async (dispatch) => {
    try{
        ...
        const {data} = await axios.get(`https://hirehub-i0p4.onrender.com/api/v1/job/${id}`) ;
...
export const saveJob = (id) => async (dispatch) => {
    try{
        ...
        const {data} = await axios.get(`https://hirehub-i0p4.onrender.com/api/v1/saveJob/${id}`,config) ;
...
export const getSavedJobs = () => async (dispatch) => {
    try{
        ...
        const {data} = await axios.get("https://hirehub-i0p4.onrender.com/api/v1/getSavedJobs",config) ;
